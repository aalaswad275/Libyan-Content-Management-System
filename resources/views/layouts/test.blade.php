 ...
 * @license MIT
 ...
 <head>
     ...
     <!-- Icons -->
     <link href="{{asset('backend3/css/font-awesome.min.css')}}" rel="stylesheet">
     <link href="{{asset('backend3/css/simple-line-icons.css')}}" rel="stylesheet">
     <!-- Main styles for this application -->
     <link href="{{asset('backend3/dest/style.css')}}" rel="stylesheet">
 </head>
 ...
 <body class="navbar-fixed sidebar-nav fixed-nav">
     ...
     <div class="sidebar">
         <nav class="sidebar-nav">
             <ul class="nav">
                 <li class="nav-item">
                     <a class="nav-link" href="/dash"><i class="icon-speedometer"></i> {{__('dashboard')}} <span class="tag tag-info">جدید</span></a>
                 </li>

                 <li class="nav-title">{{__('staff')}}</li>
                  <li class="nav-item">
                     <a class="nav-link" href="/staff"><i class="icon-user-follow"></i> {{__('Staff Members')}} </a>
                     <a class="nav-link" href="#"><i class="icon-people"></i> {{__('Committie ')}} </a>
                     <a class="nav-link" href="#"><i class="icon-user-following"></i> {{__('Add Member')}}</a>
                     <a class="nav-link" href="#"><i class="icon-user-following"></i> {{__('Choose Layout')}}</a>
                 </li>
                 ...
                 <li class="nav-title">
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="#"><i class="icon-docs"></i>  {{__('add projects')}}  </a>
                 </li>
                 ...
                 <li class="nav-title">
                  ...
                  <li class="nav-item">
                     <a class="nav-link" href="#"><i class="icon-people"></i>  {{__('projects')}}</a>
                     <a class="nav-link" href="#"><i class="icon-docs"></i>    {{__('publications')}}</a>
                 </li>
     ...
     <script src="{{asset('backend3/js/libs/jquery.min.js')}}"></script>
     <script src="{{asset('backend3/js/libs/tether.min.js')}}"></script>
     <script src="{{asset('backend3/js/libs/bootstrap.min.js')}}"></script>
     <script src="{{asset('backend3/js/libs/pace.min.js')}}"></script>

     <!-- Plugins and scripts required by all views -->
     <script src="{{asset('backend3/js/libs/Chart.min.js')}}"></script>

     <!-- CoreUI main scripts -->

     <script src="{{asset('backend3/js/app.js')}}"></script>

     <!-- Plugins and scripts required by this views -->
     <!-- Custom scripts required by this view -->
     <script src="{{asset('backend3/js/views/main.js')}}"></script>
