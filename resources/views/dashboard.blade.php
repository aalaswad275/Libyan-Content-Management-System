...
<head>
	...
	<link rel="stylesheet" href="{{asset('Backend2/assets/css/bootstrap.min.css')}}">
	<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i">
	<link rel="stylesheet" href="{{asset('Backend2/assets/css/ready.csss')}}">
	<link rel="stylesheet" href="{{asset('Backend2/assets/css/demo.csss')}}">
</head>
<body>
	<div class="wrapper">
